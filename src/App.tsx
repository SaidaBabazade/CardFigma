...
const App = () => {
  return <SafeAreaView style={styles.area} >
    ...
    <Image source={require('./assets/images/woman.png')} />
      ...
      <Text style={styles.h1}>{`Hey Saida,\nthere's a new course about \nFigma`}</Text>
    ...
    <Text style={styles.cardUser}>SAIDA BABAZADE</Text>
    ...
    <View style={styles.registerBorder}>
      <Text style={styles.registerName}>SAIDA BABAZADE.</Text>
    </View>
    </View>
    ...
    <View style={styles.registerBorder}>
      <Text style={styles.registerCard}>3154 6584 2568 0794</Text>
    </View>
    </View>

    <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:30,gap:10,}}>
    ...
    <View style={styles.expiryCvc}>
    <Text style={styles.cardRegister}>CVC</Text>
    <View style={styles.cardExpiry}>
      <Text style={styles.expiryDate}>757</Text>
    </View>
    </View>
